...
rst_entry   LDS     #$7FFF      ;initialise system stack
            ...
            STA     intpolltab+1
            NOP                 ;STA     MDREG       ;initialise copy of ME register
            NOP                 ;LDA     #$01
            NOP                 ;JSR     SETPMD
...
test        CLRA                    ; direction register 0=output on all bits
            LDX     #pia0base + 2   ; use pia0 register B
...
iloop1      NOP                 ; 2 cycles
            ...
            DECB
            BNE     iloop
            STA     (pia0base + piadatab)    ;write a to PIA register B data
            EORA    #$FF
            BRA     loop

* for testing initialise D32
D32init     STA     vdgbase + 3 ; set video page base to $400
            LDX     #$0400
            JSR     CLS
            RTS
